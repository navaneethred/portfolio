...
export function Island({ position, scale, rotation, isRotating, setIsRotating, setCurrentStage }: IslandProps) {
    ...
    return (
        <a.group position={position} scale={scale} rotation={rotation} ref={islandRef}>
            <mesh
